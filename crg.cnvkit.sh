...
export TMPDIR=. && cnvkit.py target $vpath/work/bedprep/cleaned-912R_A337376-variant_regions.quantized-vrsubset-callableblocks.bed --split \
    -o 912R_A337376-target.bed --avg-size 250
export TMPDIR=. && cnvkit.py antitarget -g $vpath/work/regions/912R_A337376-analysis_blocks.bed $vpath/work/bedprep/cleaned-912R_A337376-variant_regions.quantized-vrsubset-callableblocks.bed \
    -o 912R_A337376-antitarget.bed --avg-size 1000000
export TMPDIR=. && cnvkit.py reference -f /hpf/largeprojects/ccmbio/naumenko/tools/bcbio/genomes/Hsapiens/GRCh37/seq/GRCh37.fa \
    -o background-0-cnvkit.cnn \
    -t $vpath/work/structural/912R_A337376/bins/912R_A337376-target-coverage.cnn \
    -a $vpath/work/structural/912R_A337376/bins/912R_A337376-antitarget-coverage.cnn
